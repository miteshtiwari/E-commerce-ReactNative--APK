      ...
      >
        <ScrollView>
          ...
          <Pressable
            ...
            style={{ gap: 5, padding: 10, backgroundColor: "#AFEEEE" }}
          >
            ...
            {list.map((item, index) => (
              ...
              >
                ...
                <Text
                  ...
                  style={{ marginTop: 5, fontWeight: "500", fontSize: 12 }}
                >
                  {item.name}
                </Text>
              </Pressable>
          ...
          <Text
            className="p-[10]  bg-yellow-50 "
            style={{ fontSize: 18, fontWeight: "bold" }}
          >
            Trending Deals of The Week{" "}
          </Text>
          <View className="flex-row flex-wrap align-center" style={{}}>
          ...
          <ScrollView horizontal showsHorizontalScrollIndicator={false}>
            {offers.map((item, index) => (
              ...
              >
                ...
                >
                  <Text
                    className="text-center text-white bold"
                    style={{ fontSize: 13 }}
                  >
                    {" "}
                    Upto {item?.offer} off
